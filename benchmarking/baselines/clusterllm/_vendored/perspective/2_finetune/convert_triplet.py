...
# PATCH (agentic-clustering): tolerate re-runs over existing output. Upstream
# `assert not os.path.exists(output_path)` aborts the second call; we want
# idempotent reruns from orchestrate.py.
